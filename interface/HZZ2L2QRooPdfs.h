...
class RooDoubleCB2 : public RooAbsPdf {
public:
  RooDoubleCB2();
  RooDoubleCB2(const char *name, const char *title,
	      RooAbsReal& _x,
	      RooAbsReal& _mean,
	      RooAbsReal& _width,
	      RooAbsReal& _alpha1,
  ...
  RooDoubleCB2(const RooDoubleCB2& other, const char* name=0) ;
  virtual TObject* clone(const char* newname) const { return new RooDoubleCB2(*this,newname); }
  inline virtual ~RooDoubleCB2() { }
